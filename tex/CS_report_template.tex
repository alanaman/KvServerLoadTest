...
\begin{document}
    ...
    \begin{titlepage}      
        \begin{center}
            ...
            {\large 
                ...
                %%%%%%%%%%%%%%%%%%%%%%%%%%%%             
                % change the following line                
                \emph{Instructor:} Mythili Vutukuru}\\[1cm] % if applicable
            ...
            \small \today % Please update this date you can use \date{April 2020} for fixed date
        \end{center}
    \end{titlepage}
    ...
    \input{chapters/02_design} % https://guides.library.bloomu.edu/litreview
    \input{chapters/03_load_test}
